...
PARASHA_BANNER = 'ddos in parsha russia'
...
class skywhyscript(object):
    ...
    def exit(self):
        self.stats()
        print("Shutting down skywhyscript")
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print("{0} skywhyscript strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1]))
...
def usage():
    ...
    print(PARASHA_BANNER)
    print()
    print(' USAGE: ./skywhyscript.py <url> [OPTIONS]')
    print()
    print(' OPTIONS:')
